                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            return data ?
                                `<img src="{{ asset('storage/foto_sebelum/') }}/${data}" class="img-thumbnail" width="100" height="100">` :
                                'No Image';
                        }
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            return data ?
                                `<img src="{{ asset('storage/foto_sesudah/') }}/${data}" class="img-thumbnail" width="100" height="100">` :
                                'No Image';
                        }
                    },
                    {
