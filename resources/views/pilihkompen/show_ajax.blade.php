    ...
    <div id="modal-master" class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <a href="{{ url('/pilihkompen') }}" class="btn btn-warning">Ambil</a>
            </div>
        </div>
    </div>
@else
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class="table table-bordered table-striped table-hover table-sm">
                    ...
                    <tr>
                        <th class="text-center text- col-2">Deskripsi Tugas</th>
            ...
            <div class="modal-footer">
                <button type="button" data-dismiss="modal" class="btn btn-warning">Ambil</button>
            </div>
        </div>
    </div>
@endempty