    ...
    <div id="modal-master" class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label>kompetensi deskripsi</label>
                    <textarea placeholder="Masukkan deskripsi" name="kompetensi_deskripsi" id="kompetensi_deskripsi" class="form-control" required></textarea>
